                ...
                <form action="/update" method="post">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <label for="exampleInputEmail2" class="form-label">Наименование:</label>
                            <input name="name" value="<%=task.getName()%>" type="text" class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail2" class="form-label">Описание:</label>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail3" class="form-label">Крайний срок:</label>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail3" class="form-label">Статус:</label>
